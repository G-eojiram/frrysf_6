              ...
              <div class="sm:flex sm:items-start">
                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                  ...
                  <div
                    ...
                    <div class="flex gap-x-1 text-gray-400 border-t py-2 pl-4">
                      <label for="location" class="text-sm">Location:</label>
                      <!-- <p class="text-sm">{{  }}</p> logic sa location.. hmm ackkkkkkk -->
                    </div>
                    ...
                    <div class="flex justify-between mb-3 mx-[1.5rem]">
                      ...
                      <div class="flex gap-4 items-center">
                        ...
                        <!-- <div> // ackkkkkkkkkkkkk yawa
                          ...
                          <searchlocation v-if="showSearchBox"
                            class="absolute top-full left-0 w-48 bg-white shadow-md py-2 px-4 rounded border border-red-500 z-50"></searchlocation>
                        </div> -->
                      </div>
                    </div>
                  </div>
