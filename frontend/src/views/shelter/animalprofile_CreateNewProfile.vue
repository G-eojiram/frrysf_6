                ...
                <div class="border-b border-gray-900/10 pb-7">
                    ...
                    <div class="mt-[1rem] grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div id="gender" class="lg:col-span-1 sm:col-span-full">
                            ...
                            <div class="mt-2">
                                <select id="animalGender" name="animalGender" v-model="selectedGender"
                                    class="block w-full rounded-md border-0 py-1.5 px-[1rem] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:max-w-xs sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-full">
                            <span class="text-sm">Selected Gender: {{ selectedGender }}</span>
                            <!-- pwede ra tangalon for check lng unsay geh select na gender huieeeeeee -->
                            <h4 class="font-medium text-gray-900">
                                Has this animal been Sterilized?
                            </h4>
                            <div class="mt-2 ml-[2rem] gap-x-5">
                                <div v-for="(category, categoryName) in categorizedOptions" :key="categoryName">
                                    <div class="mt-[1rem]">
                                        <span v-if="categoryName !== 'None'" class="font-medium text-sm text-gray-900">
                                            {{ categoryName }}
                                        </span>
                                    </div>
                                    <div v-for="(option, index) in category" :key="index"
                                        class="relative mt-2 flex gap-x-3">
                                        <div class="flex h-6 items-center">
                                            <input :id="option.id" name="spayNeuterStatus" type="radio"
                                                :value="option.value" v-model="selectedValue"
                                                class="h-4 w-4 rounded border-gray-300 text-teal-600 focus:ring-teal-600"
                                ...
                                <!-- pwede ra tangalon for check lng unsay geh select huieeeeeee -->
                                <div class="mt-4">
                                    <span class="text-sm mt-4">Selected sterilization value: {{ selectedValue }}</span>
                                </div>
                            </div>
                        </div>
...
// SterilizationOption based on selectedGender
const selectedGender = ref('');

const sterilizationOptions = ref([
    {
        id: 'intact',
        value: 'Intact',
        label: 'No - Intact',
        description: 'This animal has not been neutered or spayed.',
        category: 'None'
    },
    {
        id: 'neutered',
        value: 'Neutered',
        label: 'Yes - Neutered',
        description: 'This animal has been neutered.',
        category: 'Surgical',
        gender: 'Male'
    },
    {
        ...
        value: 'Spayed',
        label: 'Yes - Spayed',
        description: 'This animal has been spayed.',
        category: 'Surgical',
        gender: 'Female'
    },
    {
        id: 'vasectomy',
        value: 'Vasectomy',
        label: 'Yes - Vasectomized',
        description: 'This animal has undergone a vasectomy.',
        category: 'Non-Surgical',
        gender: 'Male'
    },
    {
        id: 'hysteroscopicSterilization',
        value: 'Hysteroscopic Sterilization',
        label: 'Yes - Hysteroscopically Sterilized',
        description: 'This animal is a female that has undergone hysteroscopic sterilization.',
        category: 'Non-Surgical',
        gender: 'Female'
    },
    {
        id: 'chemicalSterilization',
        value: 'Chemical Sterilization',
        label: 'Yes - Chemically Sterilized',
        description: 'This animal has undergone chemical sterilization.',
        category: 'Non-Surgical'
    },
    {
        id: 'notApplicable',
        ...
        description: 'This animal is too young or not eligible for sterilization.',
        category: 'Others'
    },
    {
        id: 'unknownSterilization',
        value: 'Unknown',
        label: 'Unknown',
        description: 'The sterilization status of this animal is unknown.',
        category: 'Others'
    }
])

// if male 'maleSterilizationOption' list or female 'femaleSterilizationOption' list.
const getSterilizationOptions = computed(() => {
    return sterilizationOptions.value.filter(option => {
        if (option.gender) {
            return option.gender === selectedGender.value;
        }
        return true;
    });
});
...
const categorizedOptions = computed(() => {
    const options = getSterilizationOptions.value;
    const categorized = {};
